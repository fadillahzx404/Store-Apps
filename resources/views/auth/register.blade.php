            ...
            <div class="row align-items-center justify-content-center row-login">
                <div class="col-lg-4">
                    ...
                    <form class="mt-3" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <input id="photo_profile" type="hidden" class="form-control photo-profile" name="photo_profile" value=0>
                        </div>
                        <button type="submit" class="btn btn-success btn-block w-100 mt-4" :disabled="this.email_unavailable">Sign Up Now
                        </button>

                            ...
                            <ul class="navbar-nav d-none d-lg-flex ml-auto">
                                <li class="nav-item dropdown">
                                    <a href="#" class="nav-link" id="navbarDropdown" role="button" data-toggle="dropdown">
                                        <img src="{{ Auth::user()->photo_profile == 0 ? '/images/user.png' : Auth::user()->photo_profile }}" alt="" class="rounded-circle profile-picture" />
                                        <span style="padding-left:10px;">Hi, {{ Auth::user()->name }}</span>
                                    </a>

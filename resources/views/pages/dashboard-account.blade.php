                            ...
                            <div class="row">
                                <div class="card-body">
                                    <div class="col-md-12 mb-3 text-center">
                                        <img id="frame" class="img-fluid rounded-circle" src="{{ Auth::user()->photo_profile == 0 ? '/images/user.png' : Storage::url(Auth::user()->photo_profile) }}" style="height: 150px;width:150px;" alt="">
                                    </div>
                                    <div class="col-md-12 mb-5 text-center">
                                        <label for="photo_profile">
                                            <a class="btn btn-primary" style="cursor: pointer;">Change Profile
                                                Image</a></label>
                                        <input type="file" name="photo_profile" id="photo_profile" accept="image/*" style="display: none;" onchange="preview()" />
                                    </div>
                                </div>
                            </div>
                        </div>

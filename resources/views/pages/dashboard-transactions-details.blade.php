                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="product-subtitle">{{ App\Models\Province::find($transaction->transaction->user->provinces_id)->name ?? 'Provinsi Tidak Ada' }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="product-title">City</div>
                                                <div class="product-subtitle">{{ App\Models\Regency::find($transaction->transaction->user->regencies_id)->name  ?? 'Kota Tidak Ada'  }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                            ...
                                            <div class="col-12 col-md-3">
                                                ...
                                                <select name="shipping_status" id="status" class="form-control form-select"
                                                    v-model="status">
